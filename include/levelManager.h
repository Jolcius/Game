...
public:
    ...
    LevelManager(vector<Cube*>& vec)
    {
        ...
        cube_tex = new Texture_cube(GAME_HOME "assets/textures/container.jpg");
        ceiling_tex = new Texture_cube(GAME_HOME "assets/textures/ceiling.jpg");
        enemy_tex = new Texture_cube(GAME_HOME "assets/textures/enemy.png");
        wall_tex = new Texture_cube(GAME_HOME "assets/textures/wall.jpg");
        bucket_tex = new Texture_cube(GAME_HOME "assets/textures/bucket.png");
        machine_tex = new Texture_cube(GAME_HOME "assets/textures/machine.png");
        bullet_tex = new Texture_cube(GAME_HOME "assets/textures/bullet.png");
